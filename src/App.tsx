...
const projects: Project[] = [
  { id: 1, title: 'Real POS System', category: 'Web Application', description: 'A modern point-of-sale system for growing retail teams with real-time inventory.', budget: '$8,000 â€“ $12,000', status: 'OPEN', bids: 8, updated: '2 hours ago', accent: 'coral' },
  { id: 2, title: 'Customer Management CRM', category: 'SaaS Platform', description: 'Centralize customer data, sales activity, and follow-ups in one simple workspace.', budget: '$12,000 â€“ $18,000', status: 'MATCHED', bids: 12, updated: 'Yesterday', accent: 'sky' },
  { id: 3, title: 'Business Operations Platform', category: 'Business Software', description: 'Connect projects, team workflows, approvals, and reporting across the business.', budget: '$20,000 â€“ $28,000', status: 'COMPLETED', bids: 16, updated: 'May 16, 2024', accent: 'gold' },
  { id: 4, title: 'Inventory Management', category: 'Web Application', description: 'Keep stock levels accurate and teams aligned with a focused inventory system.', budget: '$7,000 â€“ $10,000', status: 'DRAFT', bids: 0, updated: 'May 14, 2024', accent: 'mint' },
];
    ...
    <div className="app-shell">
      ...
      <div className="workspace">
        <aside className={`sidebar ${mobileOpen ? 'sidebar-open' : ''}`}>
          ...
          <div className="sidebar-bottom"><div className="help-card"><div className="help-icon"><Headphones size={16} /></div><strong>Need a hand?</strong><p>Our team is here to help you build better.</p><button onClick={() => notify('Support request started')}>Visit help center <ArrowUpRight size={13} /></button></div><div className="sidebar-footer"><span>Â© 2026 PataDev.Ke</span><button>Privacy</button><button>Terms</button></div></div>
        </aside>
...
function Overview({ role, go, projects, notify }: { role: Role; go: (view: View) => void; projects: Project[]; notify: (message: string) => void }) {
  ...
  return <>
    <div className="welcome-row"><div><p className="greeting">Tuesday, May 21, 2024</p><h1>Good morning, Jordan <span className="wave">âœ¦</span></h1><p className="welcome-sub">{isClient ? 'Hereâ€™s the latest on your projects and the people building them.' : 'Your next great project is closer than you think.'}</p></div><button className="button button-primary" onClick={() => go(isClient ? 'new-project' : 'browse')}><Plus size={17} />{isClient ? 'Create a project' : 'Browse projects'}</button></div>
  ...
  return (
    <footer className="site-footer">
      ...
      <div className="footer-bottom">
        <span>Â© 2026 PataDev.Ke. All rights reserved.</span>
