          ...
          {FAQS.map((faq, idx) => {
            ...
            return (
              <div
                key={idx}
                className={cn(
                  'rounded-3xl bg-white/85 backdrop-blur-xl border border-white shadow-lg overflow-hidden transition-all duration-300',
                  isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8',
                )}
                style={{
              ...
              >
                <button
                  ...
                  className="w-full px-7 py-5 flex items-center justify-between gap-4 text-left transition-colors hover:bg-white/40"
