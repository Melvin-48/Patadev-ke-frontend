...
export default function LandingFooter() {
  ...
  return (
    <footer className="bg-[#0F2A5F] text-white pt-20 pb-8 border-t border-blue-900/50">
      <div className="max-w-7xl mx-auto px-5 sm:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-2 pr-0 lg:pr-10">
            ...
            <p className="text-sm text-white/90 leading-relaxed max-w-sm mb-6">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/projects" className="text-sm text-white/80 hover:text-white transition-colors">Find Developers</Link></li>
              <li><Link to="/signup" className="text-sm text-white/80 hover:text-white transition-colors">Post a Project</Link></li>
              <li><a href="#how-it-works" className="text-sm text-white/80 hover:text-white transition-colors">How It Works</a></li>
              <li><a href="#" className="text-sm text-white/80 hover:text-white transition-colors">Payment Protection</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/projects" className="text-sm text-white/80 hover:text-white transition-colors">Browse Projects</Link></li>
              <li><Link to="/signup" className="text-sm text-white/80 hover:text-white transition-colors">Create Profile</Link></li>
              <li><a href="#" className="text-sm text-white/80 hover:text-white transition-colors">Submit a Proposal</a></li>
              <li><a href="#" className="text-sm text-white/80 hover:text-white transition-colors">Developer Resources</a></li>
            </ul>
          </div>
